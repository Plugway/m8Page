...
// Show the buttons only at step nine
  tl.from([".btn--yes", ".btn--no"], 0.7, {
    opacity: 0,
    y: 10,
  }, "+=2");

  btnYes.onclick = () => {
	  btnYes.innerHTML = "😊"; // Add the emoji before animation
  TweenMax.to(btnYes, 1, {
    x: "+=20", // Move to the right
    yoyo: true, // Animate back and forth
    repeat: 3,
    ease: Power2.easeInOut, // Smooth animation
  });
